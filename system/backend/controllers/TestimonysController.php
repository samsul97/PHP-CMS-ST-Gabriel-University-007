...
class TestimonysController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->validate()) {
            ...
            if ($image)
            {
                $file = Yii::$app->params['upload'] . 'testimonys/' . $image->baseName . '.' . $image->extension;
            ...
            Yii::$app->getSession()->setFlash('testimonys_save', [
                    'type'     => 'success',
                    'duration' => 5000,
            ...
            if ($model->errors)
            {
                ...
                Yii::$app->getSession()->setFlash('testimonys_error', [
                        'type'     => 'error',
                        'duration' => 5000,
                        'title'  => 'Error',
                        'message'  => $message,
