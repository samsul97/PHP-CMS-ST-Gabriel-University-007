...
/* @var $searchModel backend\models\TestimonysSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('backend', 'Testimonys');
...
<div class="testimonys-index">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p>
                <?= Html::a(Yii::t('backend', 'Create Testimony'), ['create'], ['class' => 'btn btn-success']) ?>
            </p>
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'name',
                            'format' => 'raw',
                            'contentOptions' => ['class' => 'text-wrap', 'style' => ['max-width' => '100px;', 'height' => '100px']],
                        ],
                        [
                            'attribute' => 'image',
                            'format' => 'raw',
