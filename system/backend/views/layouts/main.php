...
<head>
    ...
    <link rel="shortcut icon" href="<?=Url::base()?>/dist/img/favicon.ico" type="image/x-icon" />
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://www.stgabrielpreuniversity.com" class="nav-link">Home</a>
      </li>
      <!-- <li class="nav-item d-none d-sm-inline-block">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?=Url::base()?>" class="brand-link">
      <img src="<?=Url::base()?>/dist/img/admin_stgabriel.png"
           alt="Yii2 Webapps Logo"
           class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">St Gabriel's</span>
    </a>
